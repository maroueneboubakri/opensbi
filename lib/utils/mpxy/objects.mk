...
carray-fdt_mpxy_drivers-$(CONFIG_FDT_MPXY_RPMI_MM_DOMAIN) += fdt_mpxy_rpmi_mm_domain
libsbiutils-objs-$(CONFIG_FDT_MPXY_RPMI_MM_DOMAIN) += mpxy/fdt_mpxy_rpmi_mm_domain.o
