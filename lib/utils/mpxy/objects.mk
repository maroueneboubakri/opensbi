...
carray-fdt_mpxy_drivers-$(CONFIG_FDT_MPXY_RPMI_MM_FORWARD) += fdt_mpxy_rpmi_mm_forward
libsbiutils-objs-$(CONFIG_FDT_MPXY_RPMI_MM_FORWARD) += mpxy/fdt_mpxy_rpmi_mm_forward.o
